...
#if defined(USE_LPF)
#include "LPF.h"
#define TIME_CONSTANT_SECS 0.05
int16_t filteredValue;
LPF AnalogValueLPF(TIME_CONSTANT_SECS);
#endif
...
/*!
    ...
    06-06-23 possible noise in this path
*/
/**************************************************************************/
int16_t ADS1115_lite::getConversion() {
  
    do { // #3 will wait until conversion complete
  ...
  #if defined(USE_LPF)
  filteredValue = AnalogValueLPF.Step(rawValue);
